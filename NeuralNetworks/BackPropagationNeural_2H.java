 ...
 * @author ravi-zt46
 */
public class BackPropagationNeural_2H {
	...
	public float LEARNING_RATE = 0.5f;
	 ...
	 private float alpha = 0.6f;  // momentum scaling term that is applied to last delta weight
